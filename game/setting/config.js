...
const hardPlusEnemyDefinitions = [
    new EnemyDefinition(EnemyFish,            [ 1,  4], 20),
    new EnemyDefinition(EnemyTropicalfish,    [ 1,  4], 20),
    new EnemyDefinition(EnemyCrayfish,        [ 2,  6], 30),
    new EnemyDefinition(EnemyHarisenbon,      [ 6, 10], 20),
    new EnemyDefinition(EnemyCrab,            [ 1,  5],  1),
    new EnemyDefinition(EnemyOctopus,         [ 6, 10], 20),
    new EnemyDefinition(EnemySquid,           [ 6, 10], 20),
    new EnemyDefinition(EnemyJellyfish,       [ 1,  4], 20),
    new EnemyDefinition(EnemyTropicalfishLV2, [ 6, 10], 20),
    new EnemyDefinition(EnemyCrayfishLV2,     [10, 14], 30),
    new EnemyDefinition(EnemyWhales,          [18, 22], 10),
    new EnemyDefinition(EnemyHarisenbonLV2,   [11, 15], 20),
    new EnemyDefinition(EnemyShark,           [12, 16], 10),
    new EnemyDefinition(EnemyWaterDragon,     [17, 21],  1),
    new EnemyDefinition(EnemyCrabLV2,         [14, 18],  1),
    new EnemyDefinition(EnemyOctopusLV2,      [12, 16], 20),
    new EnemyDefinition(EnemySquidLV2,        [12, 16], 20),
    new EnemyDefinition(EnemyJellyfishLV2,    [ 7, 11], 20),
    new EnemyDefinition(EnemyWhalesLV2,       [24, 28], 10),
    new EnemyDefinition(EnemySharkLV2,        [19, 23], 10),
    new EnemyDefinition(EnemyWaterDragonLV2,  [24, 28],  1),
]

...
class EnemyFish extends Enemy {
	constructor(x, y) {
		super("フィッシュ", x, y, /* LV */ 1, /* EXP */ 3, /* HP */ 2, /* ATK */ 1, /* DEF */ 2, '🐟️')
	}
}
class EnemyTropicalfish extends Enemy {
	constructor(x, y) {
		super("トロピカフィッシュ", x, y, /* LV */ 1, /* EXP */ 9, /* HP */ 6, /* ATK */ 5, /* DEF */ 6, '🐠')
...
class EnemyCrab extends Enemy {
	constructor(x, y) {
		super("カニ", x, y, /* LV */ 1, /* EXP */ 200, /* HP */ 10, /* ATK */ 8, /* DEF */ 30, '🦀')
...
class EnemyCrayfish extends Enemy {
	constructor(x, y) {
		super("ザリガニ", x, y, /* LV */ 1, /* EXP */ 18, /* HP */ 14, /* ATK */ 10, /* DEF */ 14, '🦞')
	}
}
class EnemyHarisenbon extends Enemy {
	constructor(x, y) {
		super("ハリセンボン", x, y, /* LV */ 1, /* EXP */ 25, /* HP */ 20, /* ATK */ 13, /* DEF */ 20, '🐡')
	}
}
class EnemyOctopus extends Enemy {
	constructor(x, y) {
		super("タコ", x, y, /* LV */ 1, /* EXP */ 29, /* HP */ 24, /* ATK */ 16, /* DEF */ 24, '🐙')
        this.skills = [
...
class EnemySquid extends Enemy {
	constructor(x, y) {
		super("イカ", x, y, /* LV */ 1, /* EXP */ 34, /* HP */ 28, /* ATK */ 18, /* DEF */ 28, '🦑')
        this.skills = [
            Skill.debuffInk(this)
        ]
	}
...
class EnemyJellyfish extends Enemy {
	constructor(x, y) {
		super("クラゲ", x, y, /* LV */ 1, /* EXP */ 39, /* HP */ 32, /* ATK */ 21, /* DEF */ 32, '🪼')
		this.searchAlgo = (game, sx, sy, tx, ty) =>
			SearchAlgorithm.randomRoute(game, sx, sy, tx, ty)
	}
}
class EnemyWhales extends Enemy {
	constructor(x, y) {
		super("クジラ", x, y, /* LV */ 1, /* EXP */ 44, /* HP */ 38, /* ATK */ 24, /* DEF */ 38, '🐋')
	}
}
class EnemyShark extends Enemy {
	constructor(x, y) {
		super("シャーク", x, y, /* LV */ 1, /* EXP */ 48, /* HP */ 42, /* ATK */ 26, /* DEF */ 42, '🦈')
		this.action = this.maxAction = 2
	}
}
class EnemyWaterDragon extends Enemy {
	constructor(x, y) {
		super("水龍", x, y, /* LV */ 1, /* EXP */ 53, /* HP */ 46, /* ATK */ 29, /* DEF */ 46, '🦕')
		this.breathAtk = 10
...
class EnemyFishLV2 extends Enemy {
	constructor(x, y) {
		super("強いフィッシュ", x, y, /* LV */ 2, /* EXP */ 57, /* HP */ 50, /* ATK */ 32, /* DEF */ 50, '🐟️')
	}
}
class EnemyTropicalfishLV2 extends Enemy {
	constructor(x, y) {
		super("強いトロピカフィッシュ", x, y, /* LV */ 2, /* EXP */ 62, /* HP */ 56, /* ATK */ 35, /* DEF */ 56, '🐠')
		this.searchAlgo = (game, sx, sy, tx, ty) =>
			SearchAlgorithm.randomRoute(game, sx, sy, tx, ty)
	}
}
class EnemyCrabLV2 extends Enemy {
	constructor(x, y) {
		super("強いカニ", x, y, /* LV */ 2, /* EXP */ 800, /* HP */ 60, /* ATK */ 37, /* DEF */ 120, '🦀')
		this.searchAlgo = (game, startX, startY, targetX, targetY) =>
			SearchAlgorithm.routeFlee(game, startX, startY, targetX, targetY)
		this.action = this.maxAction = 2; // 二回行動
	}
...
class EnemyCrayfishLV2 extends Enemy {
	constructor(x, y) {
		super("強いザリガニ", x, y, /* LV */ 2, /* EXP */ 72, /* HP */ 66, /* ATK */ 40, /* DEF */ 66, '🦞')
	}
}
class EnemyHarisenbonLV2 extends Enemy {
	constructor(x, y) {
		super("強いハリセンボン", x, y, /* LV */ 2, /* EXP */ 75, /* HP */ 68, /* ATK */ 43, /* DEF */ 68, '🐡')
	}
}
class EnemyOctopusLV2 extends Enemy {
	constructor(x, y) {
		super("強いタコ", x, y, /* LV */ 2, /* EXP */ 81, /* HP */ 74, /* ATK */ 46, /* DEF */ 74, '🐙')
        this.skills = [
            Skill.debuffInk(this)
        ]
	}
...
class EnemySquidLV2 extends Enemy {
	constructor(x, y) {
		super("強いイカ", x, y, /* LV */ 2, /* EXP */ 83, /* HP */ 78, /* ATK */ 46, /* DEF */ 78, '🦑')
        this.skills = [
            Skill.debuffInk(this)
        ]
	}
...
class EnemyJellyfishLV2 extends Enemy {
	constructor(x, y) {
		super("強いクラゲ", x, y, /* LV */ 2, /* EXP */ 90, /* HP */ 84, /* ATK */ 51, /* DEF */ 84, '🪼')
		this.searchAlgo = (game, sx, sy, tx, ty) =>
			SearchAlgorithm.randomRoute(game, sx, sy, tx, ty)
	}
}
class EnemyWhalesLV2 extends Enemy {
	constructor(x, y) {
		super("強いクジラ", x, y, /* LV */ 2, /* EXP */ 91, /* HP */ 86, /* ATK */ 52, /* DEF */ 86, '🐋')
	}
}
class EnemySharkLV2 extends Enemy {
	constructor(x, y) {
		super("強いシャーク", x, y, /* LV */ 2, /* EXP */ 97, /* HP */ 92, /* ATK */ 56, /* DEF */ 92, '🦈')
		this.action = this.maxAction = 2
	}
}
class EnemyWaterDragonLV2 extends Enemy {
	constructor(x, y) {
		super("強い水龍", x, y, /* LV */ 2, /* EXP */ 100, /* HP */ 96, /* ATK */ 57, /* DEF */ 96, '🦕')
		this.breathAtk = 25
		this.skills = [ Skill.offensiveBreath(this) ]
	}
}
class EnemyFishLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いフィッシュ", x, y, /* LV */ 3, /* EXP */ 106, /* HP */ 102, /* ATK */ 60, /* DEF */ 102, '🐟️')
	}
}
class EnemyTropicalfishLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いトロピカフィッシュ", x, y, /* LV */ 3, /* EXP */ 110, /* HP */ 106, /* ATK */ 63, /* DEF */ 106, '🐠')
		this.searchAlgo = (game, sx, sy, tx, ty) =>
			SearchAlgorithm.randomRoute(game, sx, sy, tx, ty)
	}
}
class EnemyCrabLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いカニ", x, y, /* LV */ 3, /* EXP */ 5000, /* HP */ 110, /* ATK */ 65, /* DEF */ 300, '🦀')
		this.searchAlgo = (game, startX, startY, targetX, targetY) =>
			SearchAlgorithm.routeFlee(game, startX, startY, targetX, targetY)
		this.action = this.maxAction = 2; // 二回行動
	}
...
class EnemyCrayfishLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いザリガニ", x, y, /* LV */ 3, /* EXP */ 119, /* HP */ 116, /* ATK */ 68, /* DEF */ 116, '🦞')
	}
}
class EnemyHarisenbonLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いハリセンボン", x, y, /* LV */ 3, /* EXP */ 122, /* HP */ 120, /* ATK */ 71, /* DEF */ 120, '🐡')
	}
}
class EnemyOctopusLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いタコ", x, y, /* LV */ 3, /* EXP */ 126, /* HP */ 124, /* ATK */ 73, /* DEF */ 124, '🐙')
        this.skills = [
            Skill.debuffInk(this)
        ]
	}
...
class EnemySquidLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いイカ", x, y, /* LV */ 3, /* EXP */ 130, /* HP */ 128, /* ATK */ 76, /* DEF */ 128, '🦑')
        this.skills = [
            Skill.debuffInk(this)
        ]
	}
...
class EnemyJellyfishLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いクラゲ", x, y, /* LV */ 3, /* EXP */ 135, /* HP */ 134, /* ATK */ 79, /* DEF */ 134, '🪼')
		this.searchAlgo = (game, sx, sy, tx, ty) =>
			SearchAlgorithm.randomRoute(game, sx, sy, tx, ty)
	}
}
class EnemyWhalesLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いクジラ", x, y, /* LV */ 3, /* EXP */ 139, /* HP */ 138, /* ATK */ 81, /* DEF */ 138, '🐋')
	}
}
class EnemySharkLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強いシャーク", x, y, /* LV */ 3, /* EXP */ 143, /* HP */ 142, /* ATK */ 84, /* DEF */ 142, '🦈')
		this.action = this.maxAction = 2
	}
}
class EnemyWaterDragonLV3 extends Enemy {
	constructor(x, y) {
		super("かなり強い水龍", x, y, /* LV */ 3, /* EXP */ 146, /* HP */ 146, /* ATK */ 87, /* DEF */ 146, '🦕')
		this.breathAtk = 25
		this.skills = [ Skill.offensiveBreath(this) ]
	}
}